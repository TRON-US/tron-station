    ...
    if (item.key === 'discord') {
      return item.divider ? (
        ...
        <Menu.Item key={key} disabled={disabled}> 
          <span className="menuTop__item-title_external">
            <a href="https://discordapp.com/invite/GsRgsTD" target="_blank" rel="noopener noreferrer">
              {title}
            </a>
          </span>
  ...
  render() {
    ...
    return (
      <div className="menuTop">
        ...
        >
          <img
            src="/resources/images/discord.png"
            alt="discord"
            style={{width: '30px', height: '30px', position: 'absolute', right: '38px', top: '10px'}}
          />
        </a>
      </div>
    )
